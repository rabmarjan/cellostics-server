...
urlpatterns = [url(r'^addresses$', views.AddressList.as_view(), name='address-list'),
               ...
               #url(r'^accountrepo$', views.Accountrepo.as_view(), name='account-list'),
               ...
               url(r'^custombillcollection$', views.CustomBillCollection.as_view(), name='billcollection-list'),
               url(r'^billcollection/(?P<pk>[0-9]+)$', views.BillCollectionDetail.as_view(), name='billcollection-detail'),
               url(r'^accountReport$', views.AccountListReport, name='account-list-Report'),
